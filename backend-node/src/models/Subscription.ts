...
export const PLANS = {
  ...
  starter: {
    ...
    yearlyPrice: 2500,
    trialDays: 0,
    limits: { maxProducts: 100, maxStaffUsers: 2, aiCreditsPerMonth: 30 },
    commission: 2,
    features: [
      '100 منتج',
      'مستخدمَي فريق',
  ...
  professional: {
    ...
    yearlyPrice: 4500,
    trialDays: 0,
    limits: { maxProducts: 500, maxStaffUsers: 5, aiCreditsPerMonth: 100 },
    commission: 0,
    features: [
      '500 منتج',
      '5 مستخدمي فريق',
  ...
  business: {
    ...
    yearlyPrice: 6990,
    trialDays: 0,
    limits: { maxProducts: -1, maxStaffUsers: -1, aiCreditsPerMonth: 300 },
    commission: 0,
    features: [
      'منتجات غير محدودة',
      'فريق غير محدود',
