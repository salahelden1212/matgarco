...
export function GlobalFooter() {
  ...
  const socialLinks = [
    ...
    { Icon: TikTokIcon, href: "https://www.tiktok.com" },
    { Icon: MessageCircle, href: "https://www.whatsapp.com" }, // WhatsApp
  ];

  return (
    <footer
      dir={isRtl ? "rtl" : "ltr"}
      className="relative overflow-hidden bg-[#000000] rounded-t-3xl pt-20 pb-8 text-white"
    >
      {/* Top Gradient Border */}
