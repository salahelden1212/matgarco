...
export default function ErideThemePage() {
  const { t, lang } = useLanguage();

  // Statically assign eRide data as this is a dedicated page
  const themeData = t.themeDetails?.eride;
  ...
  return (
    ...
    >
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-6 pt-16 pb-24 text-start">
        ...
        {/* Master Hero Cover Image - Natural Scaling Performance */}
