...
export default function SkincareThemePage() {
  const { t, lang } = useLanguage();

  // Statically assign SkinCare data as this is a dedicated page
  const themeData = t.themeDetails?.skincare;
  ...
  return (
    ...
    >
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-6 pt-16 pb-24 text-start">
        ...
        {/* Master Hero Cover Image - Force Cropping for Tall Image */}
